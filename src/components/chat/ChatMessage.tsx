        ...
        <div className={`max-w-[78%] ${isUser ? "items-end" : ""}`}>
          {isUser ? (
            ...
            <Selectable
              ...
              className="markdown-msg rounded-2xl rounded-tl-sm border border-border bg-card px-4 py-2.5 text-sm leading-relaxed text-card-foreground shadow-soft selection:bg-accent selection:text-accent-foreground"
            >
              <MarkdownContent
